...
This checkout includes a local Apple Silicon implementation. See [RUNNING.md](RUNNING.md)
for its Python 3.11 setup, model-cache requirements, tests, and evaluation commands.
